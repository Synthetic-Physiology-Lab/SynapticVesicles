...
def SV_model(y: np.ndarray, t: np.ndarray, p: dict):
    ...
    tau_GABA = p["tau_GABA"]  # VGAT time constant [s]
    tau_GABA_2 = p["tau_GABA_2"]  # GABA efflux time constant [s]
...
def SV_model_constant_modified(y: np.ndarray, t: np.ndarray, p: dict):
    """synaptic vesicle model containing vATPase, ClC-3 and passive proton leakage, VGAT and VGLUT-1
